Agent task: Disease standardization

Standardize the `Disease` field according to the rules below. Preserve the input order and return one standardized value for each original term.
